...
import {SEARCH_ADVANCE, SEARCH_RESULT, FollowerHistory, USER_PROFILE} from "../../actions/follower.history";

class SearchAdvanceProfile extends React.Component {
    formRef = undefined;
    constructor(props) {
        super(props);
    ...
    onSearch = () => {
        ...
        this.props.requestListSearchUsersAdvanced({ paramsSearch, fromScreen: this.props.fromScreen, searchMode: "advance" });
        NavigationActions.toggleTabs(true);
        if (this.props.fromScreen === USER_PROFILE) {
            NavigationActions.navigateToSearchPageFromProfile({ textSearch: '', fromScreen: this.props.fromScreen, searchMode: "advance" });
        } else {
            NavigationActions.pop();
        }
    }
...
export default SearchAdvanceProfile;